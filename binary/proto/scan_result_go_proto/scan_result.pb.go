...
type Package struct {
	...
	ContainerImageMetadataIndexes *Package_ContainerImageMetadataIndexes `protobuf:"bytes,56,opt,name=container_image_metadata_indexes,json=containerImageMetadataIndexes,proto3,oneof" json:"container_image_metadata_indexes,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (*SecretData_GrokXAIManagementAPIKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{53, 5}
}
...
func (*SecretData_PrivateKey) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{53, 6}
}
...
func (*SecretData_AzureIdentityToken) Descriptor() ([]byte, []int) {
	return file_proto_scan_result_proto_rawDescGZIP(), []int{53, 8}
}
...
const file_proto_scan_result_proto_rawDesc = "" +
	...
	"\x06status\x18\x03 \x01(\v2\x13.scalibr.ScanStatusR\x06status\"\xc2\x1c\n" +
	"\aPackage\x12\x12\n" +
	...
	" container_image_metadata_indexes\x188 \x01(\v2..scalibr.Package.ContainerImageMetadataIndexesH\x01R\x1dcontainerImageMetadataIndexes\x88\x01\x01\x1at\n" +
...
var file_proto_scan_result_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_proto_scan_result_proto_goTypes = []any{
	...
	(*ContainerImageMetadata)(nil),                // 65: scalibr.ContainerImageMetadata
	(*BaseImageChain)(nil),                        // 66: scalibr.BaseImageChain
	(*BaseImageDetails)(nil),                      // 67: scalibr.BaseImageDetails
	(*LayerMetadata)(nil),                         // 68: scalibr.LayerMetadata
	(*Package_ContainerImageMetadataIndexes)(nil), // 69: scalibr.Package.ContainerImageMetadataIndexes
	nil,                       // 70: scalibr.PodmanMetadata.ExposedPortsEntry
	(*SecretData_GCPSAK)(nil), // 71: scalibr.SecretData.GCPSAK
	(*SecretData_AnthropicWorkspaceAPIKey)(nil),     // 72: scalibr.SecretData.AnthropicWorkspaceAPIKey
	(*SecretData_AnthropicModelAPIKey)(nil),         // 73: scalibr.SecretData.AnthropicModelAPIKey
	(*SecretData_PerplexityAPIKey)(nil),             // 74: scalibr.SecretData.PerplexityAPIKey
	(*SecretData_GrokXAIAPIKey)(nil),                // 75: scalibr.SecretData.GrokXAIAPIKey
	(*SecretData_GrokXAIManagementAPIKey)(nil),      // 76: scalibr.SecretData.GrokXAIManagementAPIKey
	(*SecretData_PrivateKey)(nil),                   // 77: scalibr.SecretData.PrivateKey
	(*SecretData_AzureAccessToken)(nil),             // 78: scalibr.SecretData.AzureAccessToken
	(*SecretData_AzureIdentityToken)(nil),           // 79: scalibr.SecretData.AzureIdentityToken
	(*SecretData_OpenAIAPIKey)(nil),                 // 80: scalibr.SecretData.OpenAIAPIKey
	(*SecretData_DockerHubPat)(nil),                 // 81: scalibr.SecretData.DockerHubPat
	(*SecretData_PostmanAPIKey)(nil),                // 82: scalibr.SecretData.PostmanAPIKey
	(*SecretData_PostmanCollectionAccessToken)(nil), // 83: scalibr.SecretData.PostmanCollectionAccessToken
	(*SecretData_DigitalOceanAPIToken)(nil),         // 84: scalibr.SecretData.DigitalOceanAPIToken
	(*timestamppb.Timestamp)(nil),                   // 85: google.protobuf.Timestamp
}
var file_proto_scan_result_proto_depIdxs = []int32{
	85, // 0: scalibr.ScanResult.start_time:type_name -> google.protobuf.Timestamp
	85, // 1: scalibr.ScanResult.end_time:type_name -> google.protobuf.Timestamp
	...
	65, // 10: scalibr.Inventory.container_image_metadata:type_name -> scalibr.ContainerImageMetadata
	2,  // 11: scalibr.ScanStatus.status:type_name -> scalibr.ScanStatus.ScanStatusEnum
	7,  // 12: scalibr.PluginStatus.status:type_name -> scalibr.ScanStatus
	10, // 13: scalibr.Package.source_code:type_name -> scalibr.SourceCodeIdentifier
	15, // 14: scalibr.Package.purl:type_name -> scalibr.Purl
	21, // 15: scalibr.Package.python_metadata:type_name -> scalibr.PythonPackageMetadata
	22, // 16: scalibr.Package.javascript_metadata:type_name -> scalibr.JavascriptPackageJSONMetadata
	23, // 17: scalibr.Package.apk_metadata:type_name -> scalibr.APKPackageMetadata
	24, // 18: scalibr.Package.dpkg_metadata:type_name -> scalibr.DPKGPackageMetadata
	25, // 19: scalibr.Package.rpm_metadata:type_name -> scalibr.RPMPackageMetadata
	26, // 20: scalibr.Package.cos_metadata:type_name -> scalibr.COSPackageMetadata
	29, // 21: scalibr.Package.depsjson_metadata:type_name -> scalibr.DEPSJSONMetadata
	37, // 22: scalibr.Package.spdx_metadata:type_name -> scalibr.SPDXPackageMetadata
	39, // 23: scalibr.Package.java_archive_metadata:type_name -> scalibr.JavaArchiveMetadata
	40, // 24: scalibr.Package.java_lockfile_metadata:type_name -> scalibr.JavaLockfileMetadata
	27, // 25: scalibr.Package.pacman_metadata:type_name -> scalibr.PACMANPackageMetadata
	28, // 26: scalibr.Package.nix_metadata:type_name -> scalibr.NixPackageMetadata
	33, // 27: scalibr.Package.kernel_module_metadata:type_name -> scalibr.KernelModuleMetadata
	34, // 28: scalibr.Package.vmlinuz_metadata:type_name -> scalibr.VmlinuzMetadata
	31, // 29: scalibr.Package.portage_metadata:type_name -> scalibr.PortagePackageMetadata
	41, // 30: scalibr.Package.osv_metadata:type_name -> scalibr.OSVPackageMetadata
	44, // 31: scalibr.Package.netports_metadata:type_name -> scalibr.NetportsMetadata
	42, // 32: scalibr.Package.python_requirements_metadata:type_name -> scalibr.PythonRequirementsMetadata
	43, // 33: scalibr.Package.python_setup_metadata:type_name -> scalibr.PythonSetupMetadata
	45, // 34: scalibr.Package.containerd_container_metadata:type_name -> scalibr.ContainerdContainerMetadata
	30, // 35: scalibr.Package.snap_metadata:type_name -> scalibr.SNAPPackageMetadata
	32, // 36: scalibr.Package.flatpak_metadata:type_name -> scalibr.FlatpakPackageMetadata
	35, // 37: scalibr.Package.mac_apps_metadata:type_name -> scalibr.MacAppsMetadata
	46, // 38: scalibr.Package.containerd_runtime_container_metadata:type_name -> scalibr.ContainerdRuntimeContainerMetadata
	38, // 39: scalibr.Package.cdx_metadata:type_name -> scalibr.CDXPackageMetadata
	47, // 40: scalibr.Package.windows_os_version_metadata:type_name -> scalibr.WindowsOSVersion
	48, // 41: scalibr.Package.homebrew_metadata:type_name -> scalibr.HomebrewPackageMetadata
	49, // 42: scalibr.Package.chrome_extensions_metadata:type_name -> scalibr.ChromeExtensionsMetadata
	50, // 43: scalibr.Package.vscode_extensions_metadata:type_name -> scalibr.VSCodeExtensionsMetadata
	51, // 44: scalibr.Package.podman_metadata:type_name -> scalibr.PodmanMetadata
	53, // 45: scalibr.Package.docker_containers_metadata:type_name -> scalibr.DockerContainersMetadata
	36, // 46: scalibr.Package.macports_metadata:type_name -> scalibr.MacportsPackageMetadata
	56, // 47: scalibr.Package.winget_metadata:type_name -> scalibr.WingetPackageMetadata
	54, // 48: scalibr.Package.asdf_metadata:type_name -> scalibr.AsdfMetadata
	3,  // 49: scalibr.Package.annotations_deprecated:type_name -> scalibr.Package.AnnotationEnum
	12, // 50: scalibr.Package.exploitability_signals:type_name -> scalibr.PackageExploitabilitySignal
	69, // 51: scalibr.Package.container_image_metadata_indexes:type_name -> scalibr.Package.ContainerImageMetadataIndexes
	0,  // 52: scalibr.PackageExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	13, // 53: scalibr.PackageExploitabilitySignal.vuln_identifiers:type_name -> scalibr.VulnIdentifiers
	0,  // 54: scalibr.FindingExploitabilitySignal.justification:type_name -> scalibr.VexJustification
	16, // 55: scalibr.Purl.qualifiers:type_name -> scalibr.Qualifier
	18, // 56: scalibr.GenericFinding.adv:type_name -> scalibr.GenericFindingAdvisory
	20, // 57: scalibr.GenericFinding.target:type_name -> scalibr.GenericFindingTargetDetails
	14, // 58: scalibr.GenericFinding.exploitability_signals:type_name -> scalibr.FindingExploitabilitySignal
	19, // 59: scalibr.GenericFindingAdvisory.id:type_name -> scalibr.AdvisoryId
	...
	70, // 63: scalibr.PodmanMetadata.exposed_ports:type_name -> scalibr.PodmanMetadata.ExposedPortsEntry
	85, // 64: scalibr.PodmanMetadata.started_time:type_name -> google.protobuf.Timestamp
	85, // 65: scalibr.PodmanMetadata.finished_time:type_name -> google.protobuf.Timestamp
	55, // 66: scalibr.DockerContainersMetadata.ports:type_name -> scalibr.DockerPort
	58, // 67: scalibr.Secret.secret:type_name -> scalibr.SecretData
	59, // 68: scalibr.Secret.status:type_name -> scalibr.SecretStatus
	60, // 69: scalibr.Secret.locations:type_name -> scalibr.Location
	71, // 70: scalibr.SecretData.gcpsak:type_name -> scalibr.SecretData.GCPSAK
	72, // 71: scalibr.SecretData.anthropic_workspace_api_key:type_name -> scalibr.SecretData.AnthropicWorkspaceAPIKey
	73, // 72: scalibr.SecretData.anthropic_model_api_key:type_name -> scalibr.SecretData.AnthropicModelAPIKey
	74, // 73: scalibr.SecretData.perplexity:type_name -> scalibr.SecretData.PerplexityAPIKey
	77, // 74: scalibr.SecretData.private_key:type_name -> scalibr.SecretData.PrivateKey
	75, // 75: scalibr.SecretData.grok_xai_api_key:type_name -> scalibr.SecretData.GrokXAIAPIKey
	76, // 76: scalibr.SecretData.grok_xai_management_api_key:type_name -> scalibr.SecretData.GrokXAIManagementAPIKey
	81, // 77: scalibr.SecretData.docker_hub_pat:type_name -> scalibr.SecretData.DockerHubPat
	84, // 78: scalibr.SecretData.digitalocean:type_name -> scalibr.SecretData.DigitalOceanAPIToken
	80, // 79: scalibr.SecretData.openai_api_key:type_name -> scalibr.SecretData.OpenAIAPIKey
	82, // 80: scalibr.SecretData.postman_api_key:type_name -> scalibr.SecretData.PostmanAPIKey
	83, // 81: scalibr.SecretData.postman_collection_access_token:type_name -> scalibr.SecretData.PostmanCollectionAccessToken
	78, // 82: scalibr.SecretData.azure_access_token:type_name -> scalibr.SecretData.AzureAccessToken
	79, // 83: scalibr.SecretData.azure_identity_token:type_name -> scalibr.SecretData.AzureIdentityToken
	4,  // 84: scalibr.SecretStatus.status:type_name -> scalibr.SecretStatus.SecretStatusEnum
	85, // 85: scalibr.SecretStatus.last_updated:type_name -> google.protobuf.Timestamp
	...
	68, // 91: scalibr.ContainerImageMetadata.layer_metadata:type_name -> scalibr.LayerMetadata
	66, // 92: scalibr.ContainerImageMetadata.base_image_chains:type_name -> scalibr.BaseImageChain
	67, // 93: scalibr.BaseImageChain.base_images:type_name -> scalibr.BaseImageDetails
	52, // 94: scalibr.PodmanMetadata.ExposedPortsEntry.value:type_name -> scalibr.Protocol
